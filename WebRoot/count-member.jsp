...
<html>
  ...
  <body style="background-color: #fff">
	...
	<div class="panel panel-default" style="width: 1100px;height: 1100px;margin: 0px 160px 0px 150px"><div class="panel-body">
		<ul class="nav nav-tabs">
		   <li class="active"><a href="<%=path%>/basic-input.jsp" style="padding-left: 60px;padding-right: 60px;">成都市科协专家库</a></li>
		...
		<div id="container" style="width: 100%;margin-top: 10px;">
			...
			<div id="content"  style="margin: 0px 0px 0px 10px;"><!-- 右边 -->
				...
				<table><tbody>
					<tr>
						<td style="padding-left: 10px;"><jsp:include page="/input-part/expert-basic.jsp" flush="true"></jsp:include><!-- 顶部 --></td>
						<td style="padding-left: 10px;"><jsp:include page="/input-part/expert-basic.jsp" flush="true"></jsp:include><!-- 顶部 --></td>
						<td style="padding-left: 10px;"><jsp:include page="/input-part/expert-basic.jsp" flush="true"></jsp:include><!-- 顶部 --></td>
					</tr>
					<tr>
