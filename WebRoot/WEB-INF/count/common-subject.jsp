...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(cur_sub!="null")
				$("#seledsub").val(cur_sub);//设置input的value属性
				//findKey();//相当于 触发 查询按钮事件				
		    else{
...
<body>
	...
	<button type="button" class="btn btn-default" style="margin-bottom: 2px;width: 80px;" onclick="javascript:findInputKey()">查询</button>
</body>
</html>