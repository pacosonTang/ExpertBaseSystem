...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			function setChart_patent(tempdata){
				...
				var ctx = document.getElementById("canvas_patent").getContext("2d");
	...
	<body>
	   ...
	   <div class="panel-heading" >
	      <h3 class="panel-title" align="center">一级学科【发明专利】百分占比情况</h3>
	   </div><!-- ./panel-heading -->
	   <div class="panel-body" style="padding: 5px;">
		<div style="width: 100%; font-family:courier ">
			<canvas id="canvas_patent"></canvas>
		</div></div></div>
	</body>
</html>
